        ...
        <>
            ...
            >
                <div className="h-full flex flex-col">
                    <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-black/30">
...
const InteractiveBento: React.FC<InteractiveBentoGalleryProps> = ({ mediaItems, title, description }) => {
                        ...
                        {items.map((item, index) => (
                            ...
                            >
                                ...
                                <motion.div
                                    ...
                                    transition={{ duration: 0.2 }}
                                >
                                    <div className="absolute inset-0 flex flex-col justify-end p-2 sm:p-3 md:p-4 cursor-pointer">
                                        <div className="absolute inset-0 bg-gradient-transparent cursor-pointer" />
                                    </div>
                                </motion.div>
                            </motion.div>
                        ))}
