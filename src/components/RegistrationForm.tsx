                ...
                <div className="w-full max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-700">
                    <div className="bg-gradient-to-br from-slate-900/40 via-slate-800/40 to-black/40 backdrop-blur-xl border border-cyan-500/20 rounded-3xl shadow-2xl p-8 md:p-12">
                        ...
                        <div className="text-center mb-12">
                            ...
                            <p className="text-md md:text-lg text-gray-300">You are now part of the Open Source 101 initiative by ISTE HIT-SC</p>
                        </div>
                        ...
                        <div className="bg-white/5 border border-cyan-500/20 rounded-2xl p-6 mb-10 backdrop-blur">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-start pb-3 border-b border-white/10">
                                    ...
                                    <span className="text-sm font-semibold text-white text-right">{registrationData.data.fullName}</span>
                                </div>
                                <div className="flex justify-between items-start pb-3 border-b border-white/10">
                                    <span className="text-sm text-gray-400">Email</span>
                                    <span className="text-sm font-semibold text-white text-right break-all">
                                        {registrationData.data.email}
                                    </span>
                                </div>
                                {registrationData.data.collegeName && (
                        ...
                        <div className="cursor-pointer">
                                ...
                                <div className="space-y-4">
                                    ...
                                    >
                                        ...
                                        <div className="flex-1">
                                            <p className="font-semibold text-white text-sm cursor-pointer">Join WhatsApp Group</p>
                            ...
                            <IdCard
                                ...
                                fullName={registrationData.data.fullName}
                                githubUrl={registrationData.data.githubUrl}
                            />
                        </div>
                    </div>
                </div>
