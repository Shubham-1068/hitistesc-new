...
const mediaItems = [
    {
        id: 1,
        type: "image",
        url: "https://lh3.googleusercontent.com/d/19zr63Nkdhc7Kjx_-HXwyyp6EWy3khN6H=s1369-no",
        span: "md:col-span-1 md:row-span-3 sm:col-span-1 sm:row-span-2",
    },
    {
        id: 2,
        type: "image",
        url: "https://lh3.googleusercontent.com/d/1GmZTq7npKAQ3pAkPinzJRyGSrfNZT1Hh=s1369-no",
        span: "md:col-span-2 md:row-span-2 col-span-1 sm:col-span-2 sm:row-span-2",
    },
    {
        id: 3,
        type: "image",
        url: "https://lh3.googleusercontent.com/d/1ikJ6Y9u3ypgcBcaFHIQ1ktsUg4CjH2OM=s1369-no",
        span: "md:col-span-1 md:row-span-3 sm:col-span-1 sm:row-span-2",
    },
    {
        id: 4,
        type: "image",
        url: "https://lh3.googleusercontent.com/d/1JzRNPxBC3JEGJmF_LgiBTAosM3wxNlRm=s1369-no",
